...
<title>编辑友情链接 - Powered By SHOP++</title>
...
*/
function submits(){
	//document.getElementById("inputForm").action="/Shopxx_ht/servlet/Add_or_UpdateFriendship";
	//document.getElementById("inputForm").submit();
	//document.getElementById("inputForm")="_blank";
	//document.getElementById("inputForm").enctype="multipart/form-data";
	//document.getElementById("inputForm").action="/Shopxx_ht/servlet/UploadServlet";
	//document.getElementById("inputForm").submit();
}
	...
	<form id="inputForm" action="  " method="post" enctype="multipart/form-data" >
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
							<input type="file" id="logo" name="logo" class="text"  maxlength="200" />
					</span>
				</td>
			</tr>
			<tr>
