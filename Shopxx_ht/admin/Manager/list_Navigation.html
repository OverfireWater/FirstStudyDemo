...
A.info:hover    {color:green;background:transparent;text-decoration:underline}
	...
	<div class="path">
		<a href="  ">首页</a> &raquo;导航列表 
	</div>
	<form id="listForm" action="" method="get">
		<div class="bar">
			<a href="add_Navigation.html" class="iconButton">
				<span class="addIcon">&nbsp;</span>添加
			</a>
			<div class="buttonWrap">
				<a href="#" id="deleteButton" onclick="submits()" class="iconButton disabled">
			...
			<div class="menuWrap">
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" val="name">类型名称</a>
						</li>
						<li>
							<a href="javascript:;" val="sn">类型编号</a>
						</li>
					</ul>
				</div>
			</div>
...
<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="sn">名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="name">位置</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="productCategory">是否新窗口打开</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="price">排序</a>
				</th>
				<th>
					<span>操作</span>
				</th>
					...
					<td>
						<a href="edit_Navigation.html?nid=1">[编辑]</a>
					</td>
				</tr>
