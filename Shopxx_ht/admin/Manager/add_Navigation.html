	...
	<form id="inputForm" action="  " method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" value=""  name="nurl" class="text"  maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>位置: 
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField"></span>设置:
				</th>
				<td >
					<input type="checkbox" name="isnew"  value="1"class="checkbox" /> 是否新窗口打开
				</td>
			</tr>
			<tr>
				<th> 
