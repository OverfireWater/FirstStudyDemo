...
(function (root, factory) {
    ...
    Ssi_upload.prototype.init = function (element) {
        ...
        var $chooseBtn = $('' +
         ...
         '<button class="btn btn-primary">' + this.language.chooseFiles + '</button>' +
         '</span>').append(element);
...
//----------------------------UPLOADFILES------------------------------------
    ...
    var locale = {
    	  zh_CN: {
            ...
            clear: '删除',
            drag: '拖拽',
            sizeError: '$1文件超出最大大小 $2',// $1=file name ,$2=max ie( example.jpg has has exceed the size limit of 2mb)
            extError: '不支持$1文件类型',//$1=file extension ie(exe files are not supported)
