...
<head>
    ...
    <script>
        ...
        function Status() {
            var status = "<?=$userInfo->getUserstatus()?>";
            if (status == "1") {
...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="../Services/updateUserInfoServices.php">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="<?= $userInfo->getUsername() ?>" name="name"
                           readonly="readonly" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="nickname" value="<?= $userInfo->getNickname() ?>"
